 ...
 */
public class TrainoperationDepot {
    /**
     * id
     */
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TrainoperationDepot)) return false;

        TrainoperationDepot that = (TrainoperationDepot) o;
