...
public class TestBureauDao {
    ...
    public void before() {
        ...
        bureau.setEpsg4326("43");
        bureau.setAlias("a");
        bureau.setGeoSpatial("geo");
    ...
    public void testCRUD() {
        ...
        Assert.assertEquals(bureau.getEpsg4326(), getOne.getEpsg4326());
        Assert.assertEquals(bureau.getAlias(), getOne.getAlias());
        Assert.assertEquals(bureau.getGeoSpatial(), getOne.getGeoSpatial());
