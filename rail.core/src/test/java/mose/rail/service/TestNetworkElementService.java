...
public class TestNetworkElementService {
    ...
    private final String POINT_XY_SPLITTER = NetworkElementService.POINT_XY_SPLITTER;
    private final String POINT_SPLITTER = NetworkElementService.POINT_SPLITTER;
